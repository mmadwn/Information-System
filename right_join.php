<div class="col-sm-1">
		   <a href="./admin.php?hlm=inner" id="tombol" class="btn btn-info pull-left"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Kembali</a><br/><br/><br/>
...
<body>
    ...
    <form method="GET" action="right_join.php" style="text-align: center;"></form>
    <table>
		<thead>
			<tr>
				<th>No.Nota</th>
        ...
        FROM transaksi RIGHT JOIN biaya ON

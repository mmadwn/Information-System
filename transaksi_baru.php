...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "INSERT INTO transaksi(no_nota, jenis, nama, bayar, kembali, total, tanggal, id_biaya) VALUES('$no_nota', '$jenis', '$nama', '$bayar', '$kembali', '$total', NOW(), '$id_biaya')");
...
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<label for="id_biaya" class="col-sm-2 control-label">Jenis Voucher</label>
		<div class="col-sm-3">
			<select name="id_biaya" class="form-control" id="id_biaya" required>
				<option value="" disable>--- Pilih Jenis Voucher ---</option>
			<?php
